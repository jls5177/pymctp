...
from pymctp.layers.mctp.types import AnyPacketType, ICanSetMySummaryClasses
...
bind_layers(VdPciHdrPacket, MsftVdmProtocolPacket, vendor_id=VdPCIVendorIds.Msft, rq=1, rsv=0, unused=0, vdm_cmd_code=0xff)
